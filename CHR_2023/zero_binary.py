...
#script for annotating datasets with mlmc zeroshot. Input-files need to be in feather. Usable via argparse. This version was used for binary datasets 
...
if __name__ == "__main__":
    ...
    model = mlmc.models.Encoder(classes ={"negative":0, "positive": 1},
                                 finetune="bias",
    ...
    with open(f'{p}_time_zero.txt', 'w') as f:
